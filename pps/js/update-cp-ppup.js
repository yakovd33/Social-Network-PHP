...
// Submit update cover picture
function update_cover_picture (element) {
    $("#submit-update-pp").click(function () {
        if ($("#main-tab-aka-select-from-uploaded-pictures").css('display') == 'block') {
            ...
            $.ajax({
                url: 'form_submitions/update_cover_picture_by_index.php',
                processData: false,
                contentType: false,
                method: "POST",
                data: index,
        ...
        if ($("#upload-picture-tab").css('display') == 'block') {
            ...
            $.ajax({
                url: 'form_submitions/update_cover_picture_by_upload.php',
                processData: false,
                contentType: false,
                method: "POST",
                data: file,
        ...
        function update_picture_element () {
            $.ajax({
                url: 'general_scripts/get_user_cover_picture_url.php',
                processData: false,
                contentType: false,
                method: "POST",
                success: function (data) {
